...
export const createUiSlice: StateCreator<CyberiaState, [], [], any> = (set, get, _api) => {
  ...
  setCalendarStatusFilter: (status: 'none' | 'todo' | 'doing' | 'done' | null) => set({ calendarStatusFilter: status }),
  ...
  setKanbanStatusFilter: (status: 'none' | 'todo' | 'doing' | 'done' | null) => set({ kanbanStatusFilter: status }),
  ...
  setSpatialStackFilter: (stackId: string | null) => set({ spatialStackFilter: stackId }),
  setSpatialStatusFilter: (status: 'none' | 'todo' | 'doing' | 'done' | null) => set({ spatialStatusFilter: status }),
