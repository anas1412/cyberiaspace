...
if (bg instanceof File) {
    ...
    setCalendarViewMode: (mode: 'month' | 'week' | 'agenda') => set({ calendarViewMode: mode }),
    ...
    setCalendarStatusFilter: (statuses: string[] | null) => set({ calendarStatusFilter: statuses } as any),
    ...
    setKanbanStatusFilter: (statuses: string[] | null) => set({ kanbanStatusFilter: statuses } as any),
    ...
    setSpatialStatusFilter: (statuses: string[] | null) => set({ spatialStatusFilter: statuses } as any),
