...
const EmptyState: React.FC = () => {
  ...
  return (
    <div id="empty-guide" className="fixed inset-0 z-[5] pointer-events-none flex items-center justify-center">
      ...
      <div className="absolute top-[110px] left-[100px] rotate-[5deg] text-center flex flex-col items-center">
      ...
      <div className="absolute top-[110px] left-1/2 -translate-x-1/2 -rotate-[2deg] text-center flex flex-col items-center">
        <ChalkArrow d="M 30 70 Q 30 40 30 10 M 15 30 L 30 10 L 45 30" />
        <p className="font-['Comic_Sans_MS',_cursive] text-white/30 text-[12px] mt-2">Switch Spaces</p>
      </div>

      {/* 2. Create Thought (Bottom Center - The FAB) */}
      <div className="absolute bottom-[140px] left-1/2 -translate-x-1/2 rotate-[5deg] text-center flex flex-col items-center">
        <p className="font-['Comic_Sans_MS',_cursive] text-white/30 text-[14px] mb-2 font-bold tracking-widest uppercase">Start Here</p>
        <ChalkArrow d="M 30 10 Q 30 40 30 70 M 15 50 L 30 70 L 45 50" />
      </div>

      {/* 3. Perspective (Top Right) */}
      <div className="absolute top-[110px] right-[50px] -rotate-[5deg] text-center flex flex-col items-center">
        <ChalkArrow d="M 30 70 Q 30 40 30 10 M 15 30 L 30 10 L 45 30" />
        <p className="font-['Comic_Sans_MS',_cursive] text-white/30 text-[12px] mt-2">Change Perspective</p>
      </div>

      {/* 4. Tools (Bottom Right) */}
      <div className="absolute bottom-[140px] right-[100px] -rotate-[10deg] text-center flex flex-col items-center">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center">
        <motion.h2 
          ...
          className="font-['Comic_Sans_MS',_cursive] text-white text-[48px] tracking-[8px] font-bold"
        >
          OPEN YOUR MIND
        </motion.h2>
