...
const TableFocusEditor: React.FC = () => {
  ...
  return (
    <div id="table-focus-overlay" className="fixed inset-0 z-[10001] bg-black/95 backdrop-blur-[40px] flex items-center justify-center p-10 animate-in fade-in duration-300">
      <div className="focus-box glass rounded-[3rem] overflow-hidden border border-white/10 shadow-2xl w-full max-w-[1000px] h-full max-h-[85vh] flex flex-col">
