    ...
    <footer className="py-20 px-6 border-t border-[var(--glass-border)] relative z-10">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-10">
        ...
        <div className="flex flex-wrap items-center justify-center gap-x-8 gap-y-4 text-sm font-semibold tracking-wide text-[var(--text-muted)]">
          ...
          <a href="/legal" className="hover:text-[var(--text-primary)] transition-colors">{t('footer.legal')}</a>
          <a href="/contact" className="hover:text-[var(--text-primary)] transition-colors">{t('footer.contact')}</a>
          <a href="/feedback" className="hover:text-[var(--text-primary)] transition-colors">{t('footer.feedback')}</a>
        </div>
