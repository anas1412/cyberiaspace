          ...
          >
            ...
            {user?.plan === 'pro' ? (
              ...
              <button 
                ...
                className="w-full mb-4 flex items-center justify-between p-3 rounded-xl bg-blue-500/10 border border-blue-500/20 hover:bg-blue-500/20 transition-all group"
              >
            ...
            <div className="grid grid-cols-2 gap-2 mb-4">
              <button
                ...
                className="flex items-center justify-center gap-1.5 py-2.5 rounded-xl hover:bg-red-500/10 text-red-500/60 hover:text-red-400 text-[8px] md:text-[9px] font-black uppercase tracking-widest transition-all border border-transparent hover:border-red-500/10 disabled:opacity-30"
              ...
              <button
                ...
                className="flex items-center justify-center gap-1.5 py-2.5 rounded-xl bg-white/5 hover:bg-white/10 text-white text-[8px] md:text-[9px] font-black uppercase tracking-widest transition-all border border-white/10"
              >
