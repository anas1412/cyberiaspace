...
className="absolute group flex items-center justify-center w-12 h-12 bg-[var(--text-primary)]/10 backdrop-blur-2xl text-[var(--text-primary)] rounded-xl border border-[var(--glass-border)] shadow-2xl active:brightness-90 pointer-events-auto focus-visible:outline-none"
        ...
        <motion.button 
          ...
          onClick={handleClick}
className="group relative z-10 flex items-center justify-center w-16 h-16 bg-[var(--text-primary)]/10 backdrop-blur-2xl text-[var(--text-primary)] rounded-2xl border border-[var(--glass-border)] shadow-2xl hover:brightness-110 active:brightness-90 pointer-events-auto focus-visible:outline-none"
          >
