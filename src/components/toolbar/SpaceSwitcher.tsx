      ...
      <AnimatePresence>
        {isSpaceMenuOpen && (
          ...
          >
            ...
            <div className="flex-1 max-h-[320px] overflow-y-auto custom-scroll p-2 space-y-1">
              {spaces.map((space) => {
                ...
                return (
                  <button 
                    ...
                    className={cn(
                      "w-full px-3 py-3 rounded-xl text-[10px] uppercase font-black tracking-[0.15em] flex items-center justify-between transition-all group",
                      active 
              ...
              {spaces.length < limits.MAX_SPACES && (
                <button 
                  ...
                  className="w-full px-3 py-3 rounded-xl text-[10px] uppercase font-black tracking-[0.2em] flex items-center gap-3 text-slate-500 hover:text-white hover:bg-white/5 transition-all group border border-dashed border-white/5 mt-1"
                >
            ...
            {/* Active Space Settings - Match Chat Footer Style */}
            {activeSpace && (
              <div className="p-4 md:p-5 bg-black/40 border-t border-white/5 space-y-4">
                ...
                <div className="flex items-center gap-1.5">
                  <button 
                    ...
                    className="flex-1 h-10 rounded-xl bg-white/5 border border-white/5 text-slate-400 hover:text-white hover:bg-white/10 transition-all flex items-center justify-center group" 
                    title="Rename Space"
                  >
                  ...
                  <button 
                    ...
                    className="flex-1 h-10 rounded-xl bg-blue-500/5 border border-blue-500/10 text-blue-400/70 hover:text-blue-300 hover:bg-blue-500/10 transition-all flex items-center justify-center group" 
                    title="Share Space"
                  >
                  ...
                  <button 
                    ...
                    className="flex-1 h-10 rounded-xl bg-red-500/5 border border-red-500/10 text-slate-600 hover:text-red-400 hover:bg-red-500/10 transition-all flex items-center justify-center group" 
                    title="Delete Space"
                  >
                    <Trash2 className="w-4 h-4 group-hover:scale-110 group-hover:rotate-6 transition-transform" />
                  </button>
                </div>
              </div>
            )}
